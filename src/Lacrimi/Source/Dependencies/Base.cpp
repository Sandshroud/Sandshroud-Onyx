...
{ 
	SetDisplayWeaponIds(pMainHand ? _unit->GetEquippedItem(0) : 0, pOffHand ? _unit->GetEquippedItem(1) : 0);
}
...
{
	//Main Hand
	_unit->SetEquippedItem(0, pItem1Id);

	//Off Hand
	_unit->SetEquippedItem(1, pItem2Id);
}
