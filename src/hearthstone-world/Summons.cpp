...
void Spell::SpellEffectSummon(uint32 i)
{
	...
	case DBC_SUMMON_TYPE_WILD:
	case DBC_SUMMON_TYPE_SUMMON:
		{
	...
	case DBC_SUMMON_TYPE_TOTEM_1:
	case DBC_SUMMON_TYPE_TOTEM_2:
	case DBC_SUMMON_TYPE_TOTEM_3:
	case DBC_SUMMON_TYPE_TOTEM_4:
	case DBC_SUMMON_TYPE_CREATE_TOTEM:
		{
			SummonTotem(i, spe, cp, v);
		}break;
	case DBC_SUMMON_TYPE_CRITTER:
		{
			SummonCompanion(i, spe, cp, v);
		}break;
	case DBC_SUMMON_TYPE_POSSESSED:
		{
			SummonPossessed(i, spe, cp, v);
		}break;
	default:
