...
//	custom functions for scripting
	...
	void SetAnimProgress(uint32 animprogress) { SetUInt32Value( GAMEOBJECT_ANIMPROGRESS, animprogress ); }
	uint32 GetAnimProgress() { return GetUInt32Value( GAMEOBJECT_ANIMPROGRESS ); }
	...
	uint8 GetType() { return GetUInt32Value( GAMEOBJECT_TYPE_ID ); }
