...
void CommandTableStorage::Init()
{
	static ChatCommand modifyCommandTable[] =
	{
		...
		{ "talents",					COMMAND_LEVEL_M, &ChatHandler::HandleModifyTPsCommand,			"Talent points",			NULL, 0,							0,						0 },
	...
	static ChatCommand GameObjectCommandTable[] =
	{
		...
		{ "f_dynflags",				COMMAND_LEVEL_G, NULL,									"Dynflags",										NULL, GAMEOBJECT_DYN_FLAGS,	0, 3 },
		{ NULL,						COMMAND_LEVEL_0, NULL,									"",												NULL, 0,					0, 0 }
	};
