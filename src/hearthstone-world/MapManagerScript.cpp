...
Creature *MapManagerScript::SpawnCreature( uint32 pEntry, float pX, float pY, float pZ, float pO )
{
...
Creature *MapManagerScript::SpawnCreature( uint32 pEntry, float pX, float pY, float pZ, float pO, uint32 pFactionId )
{
	CreatureProto * proto = CreatureProtoStorage.LookupEntry(pEntry);
	CreatureInfo * info = CreatureNameStorage.LookupEntry(pEntry);
	if(proto == NULL || info == NULL)
