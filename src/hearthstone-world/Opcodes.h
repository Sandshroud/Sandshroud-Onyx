...
//									Hex				Decimal			BitComments
	...
	UNIT_NPC_FLAG_TRAINER		= 0x00000010,	//16,			04
	UNIT_NPC_FLAG_VENDOR		= 0x00000080,	//128,			05	Vendor (CMSG_LIST_INVENTORY)
	UNIT_NPC_FLAG_ARMORER		= 0x00001000,	//4096,			06
	UNIT_NPC_FLAG_TAXIVENDOR	= 0x00002000,	//8192,			07	Taxi Vendor (CMSG_TAXIQUERYAVAILABLENODES)
	UNIT_NPC_FLAG_TRAINER_PROF	= 0x00004000,	//16384,		08
	UNIT_NPC_FLAG_SPIRITHEALER	= 0x00008000,	//32768,		09	Spirithealer
	UNIT_NPC_FLAG_INNKEEPER		= 0x00010000,	//65536,		10	Innkeeper Asking for Bind Point(CMSG_BINDER_ACTIVATE)
	UNIT_NPC_FLAG_BANKER		= 0x00020000,	//131072,		11	Banker
	UNIT_NPC_FLAG_ARENACHARTER	= 0x00040000,	//262144,		12	GuildMasters also have UNIT_NPC_FLAG_TABARDCHANGER!!
	UNIT_NPC_FLAG_TABARDCHANGER	= 0x00080000,	//524288,		13	Tabard Design Changer Flag
	UNIT_NPC_FLAG_BATTLEFIELDPERSON= 0x00100000,	//1048576,		14	BattleMaster (CMSG_BATTLEMASTER_HELLO (0x02D7))
	UNIT_NPC_FLAG_AUCTIONEER	= 0x00200000,	//2097152,		15	Auctioneer (MSG_AUCTION_HELLO)
	UNIT_NPC_FLAG_STABLEMASTER	= 0x00400000,	//4194304,		16	(MSG_LIST_STABLED_PETS (0x026F))
	UNIT_NPC_FLAG_GUILD_BANK	= 0x00800000,	//8388608,		17
	UNIT_NPC_FLAG_SPELLCLICK	= 0x01000000,	//16777216,		18
};
