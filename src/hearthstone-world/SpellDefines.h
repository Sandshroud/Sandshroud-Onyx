...
#define SPELL_GROUPS	64 // bit mask times twooooooo

static void SM_FFValue( int32* m, float* v, ClassFamilyMask mask )
{
	if( m == 0 )
		return;
...
static void SM_FIValue( int32* m, int32* v, ClassFamilyMask mask )
{
	if( m == 0 )
		return;
...
static void SM_PIValue( int32* m, int32* v, ClassFamilyMask mask )
{
	if( m == 0 )
		return;
...
static void SM_PFValue( int32* m, float* v, ClassFamilyMask mask )
{
	if( m == 0 )
		return;
...
enum DBC_SUMMON_TYPE
{
	...
	DBC_SUMMON_TYPE_CRITTER = 41,
	DBC_SUMMON_TYPE_WILD = 64,
	DBC_SUMMON_TYPE_GUARDIAN = 61,
	DBC_SUMMON_TYPE_POSSESSED = 65,
	DBC_SUMMON_TYPE_DEMON = 66,
	DBC_SUMMON_TYPE_SUMMON = 67,

	DBC_SUMMON_TYPE_TOTEM_1 = 63,
	DBC_SUMMON_TYPE_TOTEM_2 = 81,
	DBC_SUMMON_TYPE_TOTEM_3 = 82,
	DBC_SUMMON_TYPE_TOTEM_4 = 83,
	DBC_SUMMON_TYPE_CREATE_TOTEM = 121,
};
...
enum CastInterruptFlags
{
	...
	CAST_INTERRUPT_ON_DAMAGE_TAKEN		= 0x2,
	CAST_INTERRUPT_ON_SILENCE			= 0x4,
	CAST_INTERRUPT_ON_AUTO_ATTACK		= 0x8,
	CAST_INTERRUPT_ON_DIRECT_DAMAGE		= 0x10
};
...
enum SpellGoFlags
{
	...
	SPELL_CAST_FLAGS_HIDDEN_IN_LOG			= 0x00000001, // Unconfirmed
...
typedef enum SpellEffectTarget
{
	...
	TOTAL_SPELL_TARGET									= 91	// note: This is the highest known as of 3.3.3
} SpellEffectTarget;
