...
enum EGameObjectFields
{
	...
	GAMEOBJECT_ROTATION							= OBJECT_END + 0x0004, // Size: 1, Type: FLOAT, Flags: PUBLIC
	GAMEOBJECT_ROTATION_01						= OBJECT_END + 0x0005, // Size: 1, Type: FLOAT, Flags: PUBLIC
	GAMEOBJECT_ROTATION_02						= OBJECT_END + 0x0006, // Size: 1, Type: FLOAT, Flags: PUBLIC
	GAMEOBJECT_ROTATION_03						= OBJECT_END + 0x0007, // Size: 1, Type: FLOAT, Flags: PUBLIC
...
#define PLAYER_VISIBLE_ITEM_LENGTH 16

#define VIRTUAL_ITEM_INFO_0_OFFSET_CLASS 0
#define VIRTUAL_ITEM_INFO_0_OFFSET_SUBCLASS 1
#define VIRTUAL_ITEM_INFO_0_OFFSET_UNK0 2
#define VIRTUAL_ITEM_INFO_0_OFFSET_MATERIAL 3

#define VIRTUAL_ITEM_INFO_1_OFFSET_INVENTORYTYPE 0
#define VIRTUAL_ITEM_INFO_1_OFFSET_SHEATH 1
